-- This file contains custom lua functions for julia---------------------------

-- initialization function
local function julia_initializeScript()
    -- removing any previous entries
    vim.cmd("normal! ggVGd")
    vim.cmd("normal! i#!/bin/julia")
...
local function julia_initializePlot()
...
vim.api.nvim_create_user_command('JuliaInitializePlot',julia_initializePlot,{})
